...
public class Main {
    ...
    private static Automate loadAutomate(int automateNumber) {
        String automateFileName = String.format("C:\\Users\\WolfoS\\IdeaProjects\\Projet Automates finis\\src\\%s\\D5-%d.txt", TEST_AUTOMATES_FOLDER, automateNumber); // Mettre chemin relatif
